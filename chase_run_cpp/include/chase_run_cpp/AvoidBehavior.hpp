...
#ifndef CHASE_RUN_CPP__AVOIDBEHAVIOR_HPP_
#define CHASE_RUN_CPP__AVOIDBEHAVIOR_HPP_
...
private:
  ...
  const rclcpp::Duration TURN_TIME {1.5s};
  const rclcpp::Duration BACK_TIME {1.5s};
...
#endif  // CHASE_RUN_CPP__AVOIDBEHAVIOR_HPP_
