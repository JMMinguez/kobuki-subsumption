...
#ifndef CHASE_RUN_CPP__THIEFBEHAVIOR_HPP_
#define CHASE_RUN_CPP__THIEFBEHAVIOR_HPP_
...
class ThiefBehavior : public rclcpp_cascade_lifecycle::CascadeLifecycleNode
{
public:
  ThiefBehavior();
...
private:
  ...
  const rclcpp::Duration AVOID_TIME {3s};
